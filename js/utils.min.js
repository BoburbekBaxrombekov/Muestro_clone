! function () {
    ...
    a.prototype.i = "", a.prototype.set = function (d) {
        this.i = "" + d
    ...
    var i = Array.prototype.indexOf ? function (d, $, t) {
        return Array.prototype.indexOf.call(d, $, t)
    } : function (d, $, t) {
        if (t = null == t ? 0 : t < 0 ? Math.max(0, d.length + t) : t, "string" == typeof d) return "string" != typeof $ || 1 != $.length ? -1 : d.indexOf($, t);
        for (; t < d.length; t++)
            if (t in d && d[t] === $) return t;
        return -1
    };
    ...
    C.prototype.has = function (d) {
        ...
        return d != this && (d.g = {}, d.i && (d.i = {}), function d($, t) {
            for (var n = l($.j()), e = 0; e < n.length; e++) {
                var r = (u = n[e]).g;
                if (null != t.g[r]) {
                    $.i && delete $.i[u.g];
                    var i = 11 == u.i || 10 == u.i;
                    if (u.m)
                        for (var u = y(t, r), o = 0; o < u.length; o++) E($, r, i ? u[o].clone() : u[o]);
                    else u = S(t, r), i ? (i = S($, r)) ? d(i, u) : A($, r, u.clone()) : A($, r, u)
                }
            }
        }(d, this)), d
    }, $(I, C);
    ...
    }, (O.ctor = O).j = O.prototype.j, U.prototype.g = function (d) {
    ...
    $(F, U), F.prototype.g = function (d, $) {
        return (d = new d.i).m = this, d.g = $, d.i = {}, d
    }, $(V, F), V.prototype.i = function (d, $) {
    ...
    var z = new RegExp("(?:" + k() + ")$", "i"),
        q = new RegExp("^[0-9０-９٠-٩۰-۹]{2}$|^[+＋]*(?:[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～*]*[0-9０-９٠-٩۰-۹]){3,}[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～*A-Za-z0-9０-９٠-٩۰-۹]*(?:" + k() + ")?$", "i"),
        d1 = /(\$\d)/;

    function $1(d) {
        return !(d.length < 2) && A1(q, d)
    }

    function t1(d) {
        return A1(X, d) ? r1(d, Z) : r1(d, H)
    }
    ...
    function r1(d, $) {
        for (var t, n = new a, e = d.length, r = 0; r < e; ++r) null != (t = $[(t = d.charAt(r)).toUpperCase()]) && n.g(t);
        return n.toString()
    }
    ...
    function u1(d, $, t) {
        ...
        var n = M($, 1),
            e = l1($);
        if (0 == t) return a1(n, 0, e, "");
        if (!(n in R)) return e;
        d = o1(d, n, c1(n)), $ = null != $.g[3] && 0 != m($, 3).length ? 3 == t ? ";ext=" + m($, 3) : null != d.g[13] ? m(d, 13) + M($, 3) : " ext. " + M($, 3) : "";
        d: {
            for (var r = (d = 0 == y(d, 20).length || 2 == t ? y(d, 19) : y(d, 20)).length, i = 0; i < r; ++i) {
                var u, o = T(u = d[i], 3);
                if ((0 == o || 0 == e.search(m(u, 3, o - 1))) && A1(o = new RegExp(m(u, 1)), e)) {
                    d = u;
                    break d
                }
            }
        ...
        return null != d && (d = M(r = d, 2), u = new RegExp(m(r, 1)), M(r, 5), r = M(r, 4), e = 2 == t && null != r && 0 < r.length ? e.replace(u, d.replace(d1, r)) : e.replace(u, d), 3 == t && (e = (e = e.replace(/^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/, "")).replace(/[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/g, "-"))), a1(n, t, e, $)
    }
    ...
    function g1(d, $) {
        return s1(d, m($, 1)) ? s1(d, m($, 5)) ? 4 : s1(d, m($, 4)) ? 3 : s1(d, m($, 6)) ? 5 : s1(d, m($, 8)) ? 6 : s1(d, m($, 7)) ? 7 : s1(d, m($, 21)) ? 8 : s1(d, m($, 25)) ? 9 : s1(d, m($, 28)) ? 10 : s1(d, m($, 2)) ? m($, 18) || s1(d, m($, 3)) ? 2 : 0 : !m($, 18) && s1(d, m($, 3)) ? 1 : -1 : -1
    }
    ...
    function s1(d, $) {
        var t = d.length;
        return !(0 < T($, 9) && -1 == i(y($, 9), t)) && A1(M($, 2), d)
    }

    function p1(d, $) {
        if (null == $) return null;
        var t = M($, 1);
        if (null == (t = R[t])) d = null;
    ...
    function C1(d, $, t, n) {
        var e = 0 == T(r = f1(t, n), 9) ? y(m(t, 1), 9) : y(r, 9),
            r = y(r, 10);
        if (2 == n) {
            if (!e1(f1(t, 0))) return C1(d, $, t, 1);
            e1(d = f1(t, 1)) && (u(e = e.concat(0 == T(d, 9) ? y(m(t, 1), 9) : y(d, 9))), 0 == r.length ? r = y(d, 10) : u(r = r.concat(y(d, 10))))
        }
        return -1 == e[0] ? 5 : ($ = $.length, -1 < i(r, $) ? 4 : (t = e[0]) == $ ? 0 : $ < t ? 2 : e[e.length - 1] < $ ? 3 : -1 < i(e, $, 1) ? 0 : 5)
    }

    function S1(d, $) {
        var t = l1($);
        return ($ = M($, 1)) in R ? C1(d, t, $ = o1(d, $, c1($)), -1) : 1
    }

    function m1(d, $, t, n, e, r) {
        if (0 == $.length) return 0;
        $ = new a($), null == (u = null != t ? m(t, 11) : u) && (u = "NonMatch");
        var i, u, o = $.toString();
        if (u = 0 == o.length ? 20 : w.test(o) ? (o = o.replace(w, ""), $.i = "", $.g(t1(o)), 1) : (o = new RegExp(u), n1($), (u = 0 == (u = $.toString()).search(o) && (o = u.match(o)[0].length, !((i = u.substring(o).match(W)) && null != i[1] && 0 < i[1].length && "0" == r1(i[1], H)) && ($.i = "", $.g(u.substring(o)), !0))) ? 5 : 20), e && A(r, 6, u), 20 == u) return null != t && (o = "" + (u = M(t, 10)), 0 == (i = $.toString()).lastIndexOf(o, 0) && (o = new a(i.substring(o.length)), i = m(t, 1), i = new RegExp(M(i, 2)), M1(o, t, null), o = o.toString(), !A1(i, $.toString()) && A1(i, o) || 3 == C1(d, $.toString(), t, -1))) ? (n.g(o), e && A(r, 6, 10), A(r, 1, u), u) : (A(r, 1, 0), 0);
        if ($.i.length <= 2) throw Error("Phone number too short after IDD");
        d: {
            if (0 != (d = $.toString()).length && "0" != d.charAt(0))
                for (e = d.length, $ = 1; $ <= 3 && $ <= e; ++$)
                    if ((t = parseInt(d.substring(0, $), 10)) in R) {
                        n.g(d.substring($)), n = t;
                        break d
                    } n = 0
        }
        if (0 != n) return A(r, 1, n), n;
    ...
    function M1(d, $, t) {
        var n, e, r, i = d.toString(),
            u = i.length,
            o = m($, 15);
        0 == u || null == o || 0 == o.length || (u = (n = new RegExp("^(?:" + o + ")")).exec(i)) && (e = A1(o = new RegExp(M(m($, 1), 2)), i), r = u.length - 1, null == ($ = m($, 16)) || 0 == $.length || null == u[r] || 0 == u[r].length ? e && !A1(o, i.substring(u[0].length)) || (null != t && 0 < r && null != u[r] && t.g(u[1]), d.set(i.substring(u[0].length))) : (i = i.replace(n, $), e && !A1(o, i) || (null != t && 0 < r && t.g(u[1]), d.set(i))))
    }
    ...
    function T1($, t, d, n) {
        ...
        if (0 <= i ? ("+" == t.charAt(e = i + 15) && (0 < (u = t.indexOf(";", e)) ? r.g(t.substring(e, u)) : r.g(t.substring(e))), e = t.indexOf("tel:"), r.g(t.substring(0 <= e ? e + 4 : 0, i))) : (i = r.g, 0 <= (e = t.search(Y)) ? 0 <= (u = (e = (e = t.substring(e)).replace(j, "")).search(J)) && (e = e.substring(0, u)) : e = "", i.call(r, e)), 0 < (e = (i = r.toString()).indexOf(";isub=")) && (r.i = "", r.g(i.substring(0, e))), !$1(r.toString())) throw Error("The string supplied did not seem to be a phone number");
        if (i = r.toString(), !(i1(d) || null != i && 0 < i.length && w.test(i))) throw Error("Invalid country calling code");
        i = new O, n && A(i, 5, t);
        d: {
            if (0 <= (e = (t = r.toString()).search(z)) && $1(t.substring(0, e)))
                for (var u, o = (u = t.match(z)).length, l = 1; l < o; ++l)
                    if (null != u[l] && 0 < u[l].length) {
                        r.i = "", r.g(t.substring(0, e)), t = u[l];
                        break d
                    } t = ""
        }
        0 < t.length && A(i, 3, t), e = h1($, d), t = new a, u = 0, o = r.toString();
        try {
            u = m1($, o, e, t, n, i)
        } catch (d) {
            if ("Invalid country calling code" != d.message || !w.test(o)) throw d;
            if (0 == (u = m1($, o = o.replace(w, ""), e, t, n, i))) throw d
        }
        if (0 != u ? (r = c1(u)) != d && (e = o1($, u, r)) : (n1(r), t.g(r.toString()), null != d ? A(i, 1, u = M(e, 10)) : n && (delete i.g[6], i.i && delete i.i[6])), t.i.length < 2) throw Error("The string supplied is too short to be a phone number");
        if (null != e && (d = new a, M1(r = new a(t.toString()), e, d), 2 != ($ = C1($, r.toString(), e, -1)) && 4 != $ && 5 != $ && (t = r, n && 0 < d.toString().length && A(i, 7, d.toString()))), ($ = (n = t.toString()).length) < 2) throw Error("The string supplied is too short to be a phone number");
        if (17 < $) throw Error("The string supplied is too long to be a phone number");
        if (1 < n.length && "0" == n.charAt(0)) {
            for (A(i, 4, !0), $ = 1; $ < n.length - 1 && "0" == n.charAt($);) $++;
            1 != $ && A(i, 8, $)
        }
        return A(i, 2, parseInt(n, 10)), i
    }
    ...
    d("intlTelInputUtils", {}), d("intlTelInputUtils.formatNumber", function ($, d, t) {
        try {
            var n = x.g(),
                e = y1(n, $, d),
                r = S1(n, e);
            return 0 == r || 4 == r ? u1(n, e, void 0 === t ? 0 : t) : $
        } catch (d) {
            return $
        }
